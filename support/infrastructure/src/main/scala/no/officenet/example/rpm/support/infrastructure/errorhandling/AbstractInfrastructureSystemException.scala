...
abstract class AbstractInfrastructureSystemException(resourceKey: String, cause: Throwable, arguments: AnyRef*)
	extends LocalizableRuntimeException(resourceKey, cause, arguments:_*) with SystemException {
